...
# OGP PREDICTIONS
def predictions_ogp(trace, Xtrain, ytrain, Xtest, ytest, run_dir, betas, terms):
    ...
    for s in range(samples):
        ...
        Ctrain = make_c_star_matrix(Xtrain, Xtrain, psi=ell_s, sigma2=sigma2_gp_s, terms=terms)
        Ctest  = make_c_star_matrix(Xtest,  Xtrain, psi=ell_s, sigma2=sigma2_gp_s, terms=terms)
        Ctrain += sigma2_noise_s * np.eye(n_train)
