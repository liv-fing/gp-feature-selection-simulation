...
python model3_OGP_AnBeta.py --numdraws 10 --numtune 0  --data diabetes --numchains 6 --data diabetes --predict


python model3_OGP_AnBeta.py --numdraws 10000 --numtune 0  --data diabetes --numchains 6 --data diabetes --predict
