...
python model4_OGP_SampBeta.py --numdraws 10000 --numtune 0  --data diabetes --numchains 6 --data diabetes --predict --test_lambda --fixed_lambda_val 0.03
...
from helper_funcs.predicting import predictions_lasso, predictions_gp, predictions_ogp_betanosample, plot_predictions, rbf_kernel
...
def main(numdraws=1000, 
    ...
    with pm.Model() as model:
        ...
        if mechanism == 'ogp_sample': 
            ...
            terms = list(range(1, Xtrain.shape[1] + 1))
    ...
    if predict:
        predictions_ogp_betanosample(trace, Xtrain, ytrain, Xtest, ytest, outdir, 
                                     betas=None,
                                     mechanism=mechanism, 
                                     terms=terms)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mechanism', type=str, default='ogp_sample', help = 'Choose mechanism: orig, lasso, ols, ogp_sample')  
